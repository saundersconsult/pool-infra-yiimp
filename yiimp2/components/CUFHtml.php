...
class CUFHtml extends Html
{
  ...
  public static function activeLabelEx($model,$attribute,$htmlOptions=array())
  {
    ...
    self::getInputName($model,$attribute); // strip off square brackets if any
  ...
  {
    self::getInputName($model,$attribute,$htmlOptions);
//    self::clientChange('change',$htmlOptions);
  ...
  protected static function activeInputField($type,$model,$attribute,$htmlOptions)
  {
    ...
    return self::activeTextInput($model,$attribute, $htmlOptions);
  }
  ...
  public static function openActiveCtrlHolder($model,$attribute,$htmlOptions=array())
  {
    ...
    {
      $opentag = '<p id="error_'.$attribute.'" class="errorField"><strong>'.$model->getFirstError($attribute)."</strong></p>\n";
    }
  ...
  public static function openCtrlHolder($htmlOptions=array())
  {
    ...
    return self::beginTag('div', $htmlOptions);
  }

  public static function closeCtrlHolder()
  {
    return "<div style='clear:both'></div>".self::endTag('div')."\n";
  }
