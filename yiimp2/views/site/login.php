...
<div class="main-left-title">Login</div>
...
<fieldset class="inlineLabels">
  ...
  <div class="ctrlHolder">
    <?= Html::label('Username / Wallet', 'loginform-username') ?>
    <?= Html::activeTextInput($model, 'username', ['id' => 'loginform-username', 'autofocus' => true, 'class' => 'textInput tweetnews-input']) ?>
  </div>

  <div class="ctrlHolder">
    <?= Html::label('Password', 'loginform-password') ?>
    <?= Html::activePasswordInput($model, 'password', ['id' => 'loginform-password', 'class' => 'textInput tweetnews-input']) ?>
  </div>
