...
<br>
<div style="max-width:560px;margin:24px auto;padding:20px;border:2px solid #c00;background:#fff8f8;">
    <h3 style="color:#c00;margin-top:0;">&#9888; Uninstall Coin — <?= Html::encode($coin->symbol) ?></h3>
    <p>This will <strong>permanently</strong> remove all associated data for
    ...
    <p>The coin record will be disabled and marked as not installed.
        Blocks and markets are <strong>not</strong> deleted.</p>
    <p><strong>This action cannot be undone.</strong></p>
    <?= Html::beginForm($postUrl, 'post') ?>
        <?= Html::submitButton('YES, UNINSTALL COIN', ['style' => 'background:#c00;color:#fff;padding:6px 16px;border:none;cursor:pointer;font-weight:bold;']) ?>
        &nbsp;&nbsp;
  ...
  <div class="col-md-6 col-lg-5">
    <div class="card border-danger shadow-sm">
      <div class="card-header bg-danger text-white d-flex align-items-center gap-2">
        ...
        <strong>Uninstall Coin — <?= Html::encode($coin->symbol) ?></strong>
      </div>
      <div class="card-body">
        <p class="mb-2">
          This will <strong>permanently</strong> remove all associated data for
        ...
        <p class="mb-2 small text-muted">
          The coin record will be disabled and marked as not installed.
          Blocks and markets are <strong>not</strong> deleted.
        </p>
        <p class="text-danger fw-semibold mb-4">This action cannot be undone.</p>
        <?= Html::beginForm($postUrl, 'post') ?>
          <div class="d-flex gap-2">
            <?= Html::submitButton('<i class="bi bi-trash me-1"></i>Yes, uninstall coin', [
  ...
  <div class="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-red-300 dark:border-red-700 overflow-hidden">
    ...
    <div class="flex items-center gap-2 px-5 py-3 bg-red-600 dark:bg-red-700">
      ...
      <span class="text-sm font-semibold text-white">
        Uninstall Coin — <?= Html::encode($coin->symbol) ?>
      </span>
    </div>
    ...
    <div class="px-5 py-5">
      <p class="text-sm text-gray-700 dark:text-gray-300 mb-2">
        ...
        <strong class="text-gray-900 dark:text-gray-100">
          <?= Html::encode($coin->name) ?> (<?= Html::encode($coin->symbol) ?>)
        </strong>:
      </p>
      <ul class="text-sm text-gray-600 dark:text-gray-400 list-disc list-inside mb-3 space-y-0.5">
        <li>Exchange deposits</li>
        <li>Earnings</li>
        <li>Orders</li>
        <li>Shares</li>
      ...
      <?= Html::beginForm($postUrl, 'post') ?>
        <div class="flex gap-2">
          <?= Html::submitButton('Yes, uninstall coin', [
