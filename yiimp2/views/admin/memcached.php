...
echo "&nbsp;-&nbsp;<a href='/admin/memcached'>refresh memcache stats</a><br>";

$a = Yii::$app->cache->get( 'url-map');
...
printStats(Yii::$app->cache->getMemcache()->getStats());
